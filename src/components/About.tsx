...
export default function About() {
  return (
    <section id="about" className="bg-bg-primary min-h-screen py-32 px-6 md:px-20 lg:px-40 text-text-primary flex flex-col justify-center items-center relative z-20 transition-colors duration-500">
      <motion.div 
